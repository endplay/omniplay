...
FIRST_PASS = {RINDEX_MERGE_TIME:1,RINDEX_ADDR_TIME:1, RINDEX_STREAM_TIME:1,MAKE_LIVE_TIME:1,INSERT_LIVE_TIME:1,RECV_LIVE_TIME:1}
SECOND_PASS = {OUTPUT_TIME:1,INDEX_TIME:1,ADDR_TIME:1,FINISH_TIME:1,SEND_LIVE_TIME:1}

GRAPH_HEADERS = [START_DELAY,PIN_TIME,DIFT_TIME,PREPRUNE_LOCAL, FP,PRUNE_LIVE_TIME,SP]
...
PRUNE_DISP = "Prune Time"
GRAPH_HEADERS_DISP=[START_DELAY_DISP, PIN_TIME_DISP,DIFT_TIME_DISP,PREPRUNE_LOCAL_DISP,FP,PRUNE_DISP,SP]
