...
__attribute__((section("__versions"))) = {
	...
	{ 0x50eedeb8, "printk" },
	{ 0xb1e89912, "iw_cm_disconnect" },
	{ 0xd8bdfc74, "ibnl_put_attr" },
	{ 0x5152e605, "memcmp" },
	{ 0xedb144e1, "ib_get_client_data" },
	{ 0xcac6f2d8, "__ethtool_get_settings" },
	{ 0xb4390f9a, "mcount" },
