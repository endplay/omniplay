...
__attribute__((section("__versions"))) = {
	...
	{ 0x50eedeb8, "printk" },
	{ 0xa685d530, "iw_cm_disconnect" },
	{ 0x556e013d, "ibnl_put_attr" },
	{ 0x5152e605, "memcmp" },
	{ 0xedb144e1, "ib_get_client_data" },
	{ 0x7ec1758c, "__ethtool_get_settings" },
	{ 0xb4390f9a, "mcount" },
