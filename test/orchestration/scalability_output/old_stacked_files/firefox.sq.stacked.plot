...
set output "../output_graphs/firefox.sq.128.eps"
...
set title "Firefox Second Query"
set xlabel "Epoch" 
...
plot    "../norm_files/firefoxlonger.final.results.sq.128.csv" using 2 t "Start Delay" ls 1, \
